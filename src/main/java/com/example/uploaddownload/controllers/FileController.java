...
public class FileController {
	...
	// criar uma propriedade para servir de log de manipulação apartir do controller
	...
	// tentativa de determinar o tipo de conteudo do arquivo
		...
		try {
			...
			logger.info("Não foi possivel determinar o conteudo do arquivo.");
		}
		// verificar se o tipo de conteudo não pode ser verificada porque a variavel não conseguiu acessa-la
		if(contentType == null) {
